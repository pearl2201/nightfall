...
namespace Pika.Ai.Utils
{
    ...
    public sealed class RedBlackTree<TKey, TValue>
    {
        ...
        private readonly Func<TKey, int> hashKeyFunc;
        public RedBlackTree()
        {
            Root = _leaf;
        }

        public RedBlackTree(Func<TKey,int> hashKeyFunc)
        {
            Root = _leaf;
            this.hashKeyFunc = hashKeyFunc;
        }
        ...
        {
            RedBlackTreeNode<TKey, TValue> newNode = RedBlackTreeNode<TKey, TValue>.CreateNode(key, value, RedBlackTreeNode<TKey, TValue>.ColorEnum.Red, GetHashKey(key));
            Insert(newNode);
        }
