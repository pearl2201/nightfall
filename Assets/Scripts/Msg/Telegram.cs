...
public class Telegram : IComparable<Telegram>, IMemoryObject
{
    ...
    public override bool Equals(object obj)
    {
        ...
        if (MathUtil.floatToIntBits(timestamp) != MathUtil.floatToIntBits(other.timestamp)) return false;
        if (sender == null)
        {
    ...
    public override int GetHashCode()
    {
        ...
        result = prime * result + ((receiver == null) ? 0 : receiver.GetHashCode());
        result = prime * result + ((sender == null) ? 0 : sender.GetHashCode());
        result = prime * result + MathUtil.floatToIntBits(timestamp);
        return result;
    }
