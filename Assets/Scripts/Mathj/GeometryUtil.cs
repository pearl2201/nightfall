...
namespace Pika.Base.Mathj
{
    ...
    public class GeometryUtil
    {
         ...
         */
        public static float getClosestPointOnTriangle(Vector3 a, Vector3 b, Vector3 c, Vector3 p, Vector3 outV)
        {
            ...
            {
                if (outV != null)
                    outV.set(a); // barycentric coordinates (1,0,0)
                return p.dst2(a);
            }
            ...
            {
                if (outV != null)
                    outV.set(b); // barycentric coordinates (0,1,0)
                return p.dst2(b);
            }
            ...
            {
                Vector3 ret = outV != null ? outV : TMP_VEC_3;
                float v = d1 / (d1 - d3);
            ...
            {
                if (outV != null)
                    outV.set(c); // barycentric coordinates (0,0,1)
                return p.dst2(c);
            }
