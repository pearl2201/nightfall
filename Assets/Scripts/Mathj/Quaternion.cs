 ...
 */
    public class Quaternion
    {
        ...
        {
            float len = len2();
            if (len != 0.0f && !MathUtil.isEqual(len, 1f))
            {
        ...
        public Quaternion setFromCross(float x1, float y1, float z1, float x2, float y2,
                 float z2)
        {
            float dot = MathUtil.clamp(Vector3.dot(x1, y1, z1, x2, y2, z2), -1f, 1f);
            float angle = (float)Math.Acos(dot);
        ...
        public int hashCode()
        {
            int prime = 31;
            int result = 1;
            result = prime * result + MathUtil.floatToRawIntBits(w);
            result = prime * result + MathUtil.floatToRawIntBits(x);
            result = prime * result + MathUtil.floatToRawIntBits(y);
            result = prime * result + MathUtil.floatToRawIntBits(z);
            return result;
        }
        ...
        public bool equals(Object obj)
        {
            ...
            return (MathUtil.floatToRawIntBits(w) == MathUtil.floatToRawIntBits(other.w))
                    && (MathUtil.floatToRawIntBits(x) == MathUtil.floatToRawIntBits(other.x))
                    && (MathUtil.floatToRawIntBits(y) == MathUtil.floatToRawIntBits(other.y))
                    && (MathUtil.floatToRawIntBits(z) == MathUtil.floatToRawIntBits(other.z));
        }
