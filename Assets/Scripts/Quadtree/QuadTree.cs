...
namespace Pika.Ai.Quadtree
{
    ...
    public abstract class QuadTree<K, V>
    {
        ...
        {
            this.root = new Node<V>(minX, minZ, maxX - minX, maxZ - minZ, null);
        }
         ...
         * @return
         */
        public abstract List<T> getKeyValues<T>();
         ...
         * @return
         */
        protected bool intersects(double left, double bottom, double right, double top, Node<V> node)
        {
