 ...
 * 
 * @author davebaol */
public class SingleRayConfiguration<T> : RayConfigurationBase<T> where T : Vector<T>
{
    ...
    public SingleRayConfiguration(Steerable<T> owner, float length) : base(owner, 1)
    {
