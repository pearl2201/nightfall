 ...
 * 
 * @author davebaol */
public class ParallelSideRayConfiguration<T> : RayConfigurationBase<T> where T : Vector<T>
{

    private const float HALF_PI = MathUtil.PI * 0.5f;
    ...
    public ParallelSideRayConfiguration(Steerable<T> owner, float length, float sideOffset) : base(owner, 2)
    {
    ...
    public override Ray<T>[] updateRays()
    {
