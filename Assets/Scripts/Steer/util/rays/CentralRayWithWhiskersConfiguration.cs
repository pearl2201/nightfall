 ...
 * 
 * @author davebaol */
public class CentralRayWithWhiskersConfiguration<T> : RayConfigurationBase<T> where T : Vector<T>
{
    ...
    public CentralRayWithWhiskersConfiguration(Steerable<T> owner, float rayLength, float whiskerLength, float whiskerAngle) : base(owner, 3)
    {
