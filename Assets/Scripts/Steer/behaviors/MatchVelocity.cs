 ...
 * 
 * @author davebaol */
public class MatchVelocity<T> : SteeringBehavior<T> where T : Vector<T>
{
	...
	public MatchVelocity(Steerable<T> owner) : this(owner, null)
	{
	...
	public MatchVelocity(Steerable<T> owner, Steerable<T> target) : this(owner, target, 0.1f)
	{
	...
	public MatchVelocity(Steerable<T> owner, Steerable<T> target, float timeToTarget) : base(owner)
	{
