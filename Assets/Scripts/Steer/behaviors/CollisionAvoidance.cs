 ...
 * 
 * @author davebaol */
public class CollisionAvoidance<T> : GroupBehavior<T>, ProximityCallback<T> where T : Vector<T> {
	...
	public CollisionAvoidance(Steerable<T> owner, Proximity<T> proximity) :base(owner, proximity){
