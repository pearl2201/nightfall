 ...
 * 
 * @author davebaol */
public class FollowFlowField<T> : SteeringBehavior<T> where T : Vector<T>
{
    ...
    public FollowFlowField(Steerable<T> owner): this(owner, null)
    {
    ...
    public FollowFlowField(Steerable<T> owner, FlowField<T> flowField): this(owner, flowField, 0)
    {
	 ...
	 *           following. */
    public FollowFlowField(Steerable<T> owner, FlowField<T> flowField, float predictionTime): base(owner)
    {
 ...
 * 
 * @author davebaol */
public interface FlowField<T> where T : Vector<T>
{
