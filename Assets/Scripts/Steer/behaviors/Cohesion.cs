 ...
 * 
 * @author davebaol */
public class Cohesion<T> : GroupBehavior<T>, ProximityCallback<T> where T : Vector<T>
{
	...
	public Cohesion(Steerable<T> owner, Proximity<T> proximity) : base(owner, proximity)
	{
	}
