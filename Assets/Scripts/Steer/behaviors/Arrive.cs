 ...
 *
 * @author davebaol */
public class Arrive<T> : SteeringBehavior<T> where T : Vector<T>
{
    ...
    public Arrive(Steerable<T> owner) : this(owner, null)
    {
    ...
    public Arrive(Steerable<T> owner, Location<T> target) : base(owner)
    {
