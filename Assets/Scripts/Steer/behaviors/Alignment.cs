 ...
 * 
 * @author davebaol */
public class Alignment<T> : GroupBehavior<T>, ProximityCallback<T>, ISteeringBehaviourBuilder<Alignment<T>, T> where T : Vector<T>
{
    ...
    public Alignment(Steerable<T> owner, Proximity<T> proximity) : base(owner, proximity)
    {
    ...
    public Alignment<T> setEnabled(bool enabled)
    {
