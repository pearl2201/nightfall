 ...
 *
 * @author davebaol */
public class ReachOrientation<T> : SteeringBehavior<T> where T : Vector<T>
{
    ...
    public ReachOrientation(Steerable<T> owner) : this(owner, null)
    {
    ...
    public ReachOrientation(Steerable<T> owner, Location<T> target) : base(owner)
    {
    ...
    public virtual ReachOrientation<T> setTarget(Location<T> target)
    {
        this.target = target;
        return this;
    }
     ...
     * @return this behavior for chaining. */
    public virtual ReachOrientation<T> setAlignTolerance(float alignTolerance)
    {
     ...
     * @return this behavior for chaining. */
    public virtual ReachOrientation<T> setDecelerationRadius(float decelerationRadius)
    {
     ...
     * @return this behavior for chaining. */
    public virtual ReachOrientation<T> setTimeToTarget(float timeToTarget)
    {
