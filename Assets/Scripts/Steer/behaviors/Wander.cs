//package com.game.ai.steer.behaviors;
//
///*******************************************************************************
...
// * independent facing you should explicitly call {@link #setFaceEnabled(bool) setFaceEnabled(true)} before using Wander
// * behavior.
// * <p>
...
// *
// * @author davebaol */
//public class Wander<T : Vector<T>> : Face<T> {
//
...
//     * facing is used.
//     * @return this behavior for chaining. */
//    public Wander<T> setFaceEnabled (bool faceEnabled) {
...
//
//    @Override
//    public Wander<T> setEnabled (bool enabled) {
