...
// *
// * @author davebaol */
//public class FieldOfViewProximity<T : Vector<T>> : ProximityBase<T> {
//
...
//	public FieldOfViewProximity(Steerable<T> owner, Iterable<? : Steerable<T>> agents, float radius, float angle) {
//		base(owner, agents);
//		this.radius = radius;
//		setAngle(angle);
//		this.lastTime = 0;
