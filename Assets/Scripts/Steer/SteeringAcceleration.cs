 ...
 *
 * @author davebaol */
public class SteeringAcceleration<T> where T : Vector<T>
{
    ...
    public SteeringAcceleration(T linear) : this(linear, 0f)
    {
    ...
    {
        if (linear == null) throw new System.NotSupportedException("Linear acceleration cannot be null");
        this.linear = linear;
