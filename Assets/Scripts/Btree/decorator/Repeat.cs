 ...
 * 
 */
public class Repeat<E> : LoopDecorator<E> {
     ...
     * @param times 循环次数
     */
    public Repeat(int times): this(times, null)
    {
	 ...
	 */
	public Repeat(BTreeTask<E> child): this(-1, child)
    {
	 ...
	 *            the task that will be wrapped
	 */
	public Repeat(int times, BTreeTask<E> child): base(child)
    {
		this.times = times;
	}
