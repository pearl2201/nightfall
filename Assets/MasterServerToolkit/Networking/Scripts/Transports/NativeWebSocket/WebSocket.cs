...
namespace NativeWebSocket
{
  ...
  /// </summary>
  public class NWebSocket : IWebSocket {
    ...
    public class NWebSocket : IWebSocket
    {
        ...
        public NWebSocket(string url, Dictionary<string, string> headers = null)
        {
            uri = new Uri(url);
        ...
        public NWebSocket(string url, string subprotocol, Dictionary<string, string> headers = null)
        {
            uri = new Uri(url);
        ...
        public NWebSocket(string url, List<string> subprotocols, Dictionary<string, string> headers = null)
        {
            uri = new Uri(url);
    ...
    public static void DelegateOnCloseEvent (int instanceId, int closeCode) {
      ...
      if (instances.TryGetValue (instanceId, out instanceRef)) {
        ...
        public static NWebSocket CreateInstance(string url)
        {
            return new NWebSocket(url);
        }
