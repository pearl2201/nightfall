    ...
    public class ProfilesModule : BaseServerModule
    {
        ...
        protected virtual async void OnUserLoggedInEventHandler(IUserPeerExtension user)
        {
            ...
            else
            {
                ...
                profile.SaveThrottleDispatcher = new ThrottleDispatcher((int)saveProfileDebounceTime * 1000);
                profile.SendDebounceDispatcher = new DebounceDispatcher((int)clientUpdateDebounceTime * 1000);
                profile.UnloadDebounceDispatcher = new DebounceDispatcher((int)unloadProfileAfter * 1000);
        ...
        {
            profile.SaveThrottleDispatcher.ThrottleAsync(async () =>
            {
